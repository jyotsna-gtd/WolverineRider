    ...
    const fetchTours = async () => {
      try {
        ...
        if (response.data && Array.isArray(response.data)) {
          const domesticTours = response.data.filter((tour) => tour.place === "Leh Ladakh");
      ...
      <section className="relative table w-full items-center py-36 bg-[url('../../assets/images/bg/cta.jpg')] bg-top bg-no-repeat bg-cover">
        ...
        <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                <ul className="tracking-[0.5px] mb-0 inline-block">
                    ...
                    <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-white" aria-current="page">Leh Ladakh</li>
                </ul>
            </div>
      </section>
      ...
      <section className="relative md:py-24 py-16">
        <div className="container relative">
          {loading ? (
            ...
            <div className="text-center">No tours available for Leh Ladakh</div>
          )}
