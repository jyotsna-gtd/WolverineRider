        ...
        <section className="relative h-screen flex items-center justify-center text-center bg-[url('../../assets/images/bg/cta.jpg')] bg-no-repeat bg-center bg-cover">
            ...
            <div className="container relative">
                <div className="grid grid-cols-1">
                    ...
                    <p className="text-white/70 text-lg max-w-xl mx-auto">Start working with  that can provide everything you need to generate awareness, drive traffic, connect.</p>
                </div>
